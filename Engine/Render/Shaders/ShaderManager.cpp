...
#include "ShaderGroups/SingleColorShaderGroup.hpp"
#include "ShaderGroups/TextureShaderGroup.hpp"
#include "ShaderGroups/DepthShaderGroup.hpp"
#include "ShaderGroups/HUDShaderGroup.hpp"
#include "ShaderGroups/LineShaderGroup.hpp"
#include "ShaderGroups/DeferredSingleColorShaderGroup.hpp"
#include "ShaderGroups/DeferredTextureShaderGroup.hpp"
#include "ShaderGroups/DeferredShadowShaderGroup.hpp"
#include "ShaderGroups/DeferredLightShadowShaderGroup.hpp"
#include "ShaderGroups/DeferredLightSplitScreenShaderGroup.hpp"
#include "ShaderGroups/DeferredLightMultipleLightsShaderGroup.hpp"
#include "ShaderGroups/DeferredLightMultipleShadowLightsShaderGroup.hpp"
#include "ShaderGroups/DeferredTextureChunkShaderGroup.hpp"
...
/*void ShaderManager::SetPerFrameDeferredLightSplitScreenConstantBuffer(ID3D11DeviceContext * deviceContext, unsigned int nrOfDeferredBuffers, ID3D11ShaderResourceView** deferredShaderResourceViews, ID3D11ShaderResourceView * depthTexture)
{
	...
	m_d_lightSplitScreenShaders.get()->SetupPerFrameBuffer(deviceContext, nrOfDeferredBuffers, deferredShaderResourceViews, depthTexture);
}
