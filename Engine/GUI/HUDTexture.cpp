...
bool HUDTexture::Initialize(ID3D11Device * device, const std::string& textureName, Vector2i position, Vector2i dimensions)
{
...
bool HUDTexture::InitializeVertexBuffer(ID3D11Device * device)
{
...
void HUDTexture::SetPosition(Vector2i position)
{
...
void HUDTexture::SetDimensions(Vector2i dimensions)
{
...
void HUDTexture::UpdateVertices()
{
...
void HUDTexture::SetupVertexBuffer(ID3D11DeviceContext * deviceContext)
{
...
void HUDTexture::SetShaderResourceView(ID3D11ShaderResourceView * shaderResourceView)
{
	m_shaderResourceView = shaderResourceView;
}

void HUDTexture::SetDefaultShaderResourceView()
{
	m_shaderResourceView = GetShaderResourceView();
}

void HUDTexture::Render(ID3D11DeviceContext * deviceContext)
{
