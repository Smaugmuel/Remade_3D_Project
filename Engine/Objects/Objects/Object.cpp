...
#include "../../Math/MatrixEulerConversion.hpp"
...
void Object::UpdateWorldMatrix()
{
	...
	DirectX::XMMATRIX rotationMatrix = DirectX::XMLoadFloat4x4(&m_rotationMatrix);
	...
	DirectX::XMMATRIX transformation = DirectX::XMMatrixMultiply(
		...
		DirectX::XMMatrixTranspose(/*DirectX::XMLoadFloat4x4(&m_rotationMatrix)*//*transformationRot*//*DirectX::XMLoadFloat4x4(&m_rotationMatrix)*/rotationMatrix)
	);
	transformation = DirectX::XMMatrixMultiply(
		transformation,
		DirectX::XMMatrixTranspose(/*DirectX::XMLoadFloat4x4(&m_scalingMatrix)*/scaleMatrix)
	);
