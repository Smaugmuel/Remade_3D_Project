...
bool DebugWindow::Initialize(ID3D11Device * device, Vector2i screenDimensions, Vector2i bitMapDimensions)
{
...
void DebugWindow::SetPosition(Vector2i position)
{
...
void DebugWindow::SetupVertexBuffer(ID3D11DeviceContext * deviceContext)
{
...
void DebugWindow::Render(ID3D11DeviceContext * deviceContext)
{
