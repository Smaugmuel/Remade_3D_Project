...
// -----------------------------------------------------------------------------------------------------------------------------------
// | 4)     Include the sub class (preferrably) only in .cpp-files                                                                   |
// |                                                                                                                                 |
...
// | 5.1)   Performance is decreased very slightly, rows become longer and harder to read, and (subjective opinion) aestetics are lowered         |
// |                                                                                                                                              |
